...
(0, _reactDom.hydrate)(_react2.default.createElement(_App2.default, { data: window.__INITIAL_DATA__, component: window.__COMPONENT__ }), document.getElementById('app'));
