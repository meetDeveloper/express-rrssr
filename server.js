...
app.get("/", function (req, res) {
  var markup = (0, _server.renderToString)(_react2.default.createElement(_App2.default, { component: "Home" }));

  res.send("\n  <!DOCTYPE html>\n  <html>\n    <head>\n      <title>SSR with RR</title>\n      <script src=\"/bundle.js\" defer></script>\n      <script>window.__COMPONENT__ = 'Home'</script>\n    </head>\n\n    <body>\n      <div id=\"app\">" + markup + "</div>\n    </body>\n  </html>\n");
});

app.get("/popular/:id", function (req, res) {
  var promise = (0, _api.fetchPopularRepos)(req.params.id);

  promise.then(function (data) {
    var markup = (0, _server.renderToString)(_react2.default.createElement(_App2.default, { data: data, component: "Grid" }));
...
app.get("*", function (req, res) {
  var markup = (0, _server.renderToString)(_react2.default.createElement(_App2.default, { component: "NoMatch" }));
...
var _NoMatch = __webpack_require__(3);
  ...
  _createClass(App, [{
    ...
    value: function renderSwitch(param) {
      switch (param) {
        ...
        case 'Grid':
          return _react2.default.createElement(_Grid2.default, { data: this.props.data });
        case 'NoMatch':
